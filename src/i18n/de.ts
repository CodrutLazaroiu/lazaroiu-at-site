...
const de: Dictionary = {
  ...
  advisory: {
    ...
    trackRecord: [
      ...
      'Senior-Positionen bei OMV, Wood Group, Nabucco und ILF.',
      'Aktuell: unabhängiger Berater eines Enterprise-Risk-Governance-Transformationsmandats für eine europäische grenzüberschreitende Pipelinegruppe.',
    ],
    closing:
  ...
  research: {
    ...
    metaDescription:
      'Unabhängige Working Papers zu Infrastruktur, Kapitalallokation und Risiko. Aktuelles Papier: Molecules of Optionality (August 2026).',
